...
#warning 测试 开发环境 时需要修改BPushMode为BPushModeDevelopment 需要修改Apikey为自己的Apikey
    ...
    // 在 App 启动时注册百度云推送服务，需要提供 Apikey  apiKey   6I4BMjIOzOp69tYVu2zPThT0
    
    [BPush registerChannel:launchOptions apiKey:@"6I4BMjIOzOp69tYVu2zPThT0" pushMode:BPushModeDevelopment withFirstAction:nil withSecondAction:nil withCategory:nil isDebug:YES];
    // App 是用户点击推送消息启动
...
#endif
    //角标清0  为应用图标上的数字
    [[UIApplication sharedApplication] setApplicationIconBadgeNumber:6];
    /*
     // 测试本地通知
